...
window.addEventListener('DOMContentLoaded', function () {
  ...
  mobailMenuItem.forEach(function (elem) {
  ...
  caruselNav.forEach(function (elem, i) {
  ...
  btn.forEach(function (elem, i) {
    if (i === 1) {
      ...
      elem.addEventListener('click', function () {
        ...
        var scrollWidth = +window.innerWidth - +menu.clientWidth;
  ...
  modalClose.addEventListener('click', function () {
    ...
    inputs.forEach(function (elem) {
      return removeInputError(elem);
    });
  });
  navLink.forEach(function (elm) {
  ...
  function validate(elem) {
    ...
    var regExpName = elem.dataset.required;
    if (!regExpDic[regExpName]) return true;
    return regExpDic[regExpName].test(elem.value);
  }

  function inputErrorTemplate(msg) {
    return "\n      <div class = \"formControl_err\">".concat(msg, "</div>\n    ");
  }

  function showInputError(elem) {
    var parent = elem.parentElement;
    var msg = elem.dataset.invalidMessage;
  ...
  function removeInputError(el) {
    ...
    var err = parent.querySelector('.formControl_err');
    if (!err) return;
  ...
  function isValidForm() {
    ...
    return isValidForm.every(function (elem) {
      return elem === true;
    });
  }
  ...
  modalForm.addEventListener('submit', function (elem) {
    elem.preventDefault();
    var values = {};
